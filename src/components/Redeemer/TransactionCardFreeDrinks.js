...
import { HEIGHT, OpenSans_Medium, WIDTH, app_Bg } from '../common/Constants';
import moment from 'moment';

const TransactionCardFreeDrinks = (props) => {
    return (
        <TouchableOpacity onPress={() => { props.setIsDetailModal({visible:!props.isDetailModal.visible,data:props.data}) }}
            ...
            <View style={[gstyles.inRowJSB, gstyles.mt(10), gstyles.mx(12)]}>
                ...
                <Text style={gstyles.OpenSans_Bold(24, '#000000')}>
                    {Number(props.data.freedrinksUsed)} Drinks
                </Text>
            </View>
            ...
            <View style={[gstyles.inRowJSB, gstyles.mt(8), gstyles.mx(12), gstyles.mb(10)]}>
                ...
                <View style={gstyles.inRow}>
                    ...
                    <Text style={gstyles.OpenSans_Regular(12, '#000000')}>:</Text>
                    <Text style={[gstyles.OpenSans_SemiBold(10, '#000000', gstyles.size(120)),{left:10}]}
                        numberOfLines={2}
                    >
...
export default TransactionCardFreeDrinks;
